...
module nios_system_mm_interconnect_0 (
	...
	wire  [106:0] pwm_pio1_s1_agent_rf_source_data;                                                   // pwm_pio1_s1_agent:rf_source_data -> pwm_pio1_s1_agent_rsp_fifo:in_data
	...
	wire  [106:0] pwm_pio1_s1_agent_rsp_fifo_out_data;                                                // pwm_pio1_s1_agent_rsp_fifo:out_data -> pwm_pio1_s1_agent:rf_sink_data
	...
	wire          cmd_mux_013_src_valid;                                                              // cmd_mux_013:src_valid -> pwm_pio1_s1_agent:cp_valid
	wire  [105:0] cmd_mux_013_src_data;                                                               // cmd_mux_013:src_data -> pwm_pio1_s1_agent:cp_data
	wire          cmd_mux_013_src_ready;                                                              // pwm_pio1_s1_agent:cp_ready -> cmd_mux_013:src_ready
	wire   [14:0] cmd_mux_013_src_channel;                                                            // cmd_mux_013:src_channel -> pwm_pio1_s1_agent:cp_channel
	wire          cmd_mux_013_src_startofpacket;                                                      // cmd_mux_013:src_startofpacket -> pwm_pio1_s1_agent:cp_startofpacket
	wire          cmd_mux_013_src_endofpacket;                                                        // cmd_mux_013:src_endofpacket -> pwm_pio1_s1_agent:cp_endofpacket
	...
	wire  [106:0] pwm_pio2_s1_agent_rf_source_data;                                                   // pwm_pio2_s1_agent:rf_source_data -> pwm_pio2_s1_agent_rsp_fifo:in_data
	...
	wire  [106:0] pwm_pio2_s1_agent_rsp_fifo_out_data;                                                // pwm_pio2_s1_agent_rsp_fifo:out_data -> pwm_pio2_s1_agent:rf_sink_data
	...
	wire          cmd_mux_014_src_valid;                                                              // cmd_mux_014:src_valid -> pwm_pio2_s1_agent:cp_valid
	wire  [105:0] cmd_mux_014_src_data;                                                               // cmd_mux_014:src_data -> pwm_pio2_s1_agent:cp_data
	wire          cmd_mux_014_src_ready;                                                              // pwm_pio2_s1_agent:cp_ready -> cmd_mux_014:src_ready
	wire   [14:0] cmd_mux_014_src_channel;                                                            // cmd_mux_014:src_channel -> pwm_pio2_s1_agent:cp_channel
	wire          cmd_mux_014_src_startofpacket;                                                      // cmd_mux_014:src_startofpacket -> pwm_pio2_s1_agent:cp_startofpacket
	wire          cmd_mux_014_src_endofpacket;                                                        // cmd_mux_014:src_endofpacket -> pwm_pio2_s1_agent:cp_endofpacket
	...
	wire          pwm_pio1_s1_agent_rp_valid;                                                         // pwm_pio1_s1_agent:rp_valid -> router_015:sink_valid
	wire  [105:0] pwm_pio1_s1_agent_rp_data;                                                          // pwm_pio1_s1_agent:rp_data -> router_015:sink_data
	wire          pwm_pio1_s1_agent_rp_ready;                                                         // router_015:sink_ready -> pwm_pio1_s1_agent:rp_ready
	wire          pwm_pio1_s1_agent_rp_startofpacket;                                                 // pwm_pio1_s1_agent:rp_startofpacket -> router_015:sink_startofpacket
	wire          pwm_pio1_s1_agent_rp_endofpacket;                                                   // pwm_pio1_s1_agent:rp_endofpacket -> router_015:sink_endofpacket
	...
	wire          pwm_pio2_s1_agent_rp_valid;                                                         // pwm_pio2_s1_agent:rp_valid -> router_016:sink_valid
	wire  [105:0] pwm_pio2_s1_agent_rp_data;                                                          // pwm_pio2_s1_agent:rp_data -> router_016:sink_data
	wire          pwm_pio2_s1_agent_rp_ready;                                                         // router_016:sink_ready -> pwm_pio2_s1_agent:rp_ready
	wire          pwm_pio2_s1_agent_rp_startofpacket;                                                 // pwm_pio2_s1_agent:rp_startofpacket -> router_016:sink_startofpacket
	wire          pwm_pio2_s1_agent_rp_endofpacket;                                                   // pwm_pio2_s1_agent:rp_endofpacket -> router_016:sink_endofpacket
	...
	wire   [14:0] cmd_demux_001_src4_channel;                                                         // cmd_demux_001:src4_channel -> crosser_003:in_channel
	...
	wire   [14:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> cmd_mux_004:sink1_channel
	...
	wire   [14:0] rsp_demux_src0_channel;                                                             // rsp_demux:src0_channel -> crosser_004:in_channel
	...
	wire   [14:0] crosser_004_out_channel;                                                            // crosser_004:out_channel -> rsp_mux:sink0_channel
	...
	wire   [14:0] rsp_demux_src1_channel;                                                             // rsp_demux:src1_channel -> crosser_005:in_channel
	...
	wire   [14:0] crosser_005_out_channel;                                                            // crosser_005:out_channel -> rsp_mux_001:sink0_channel
	...
	wire   [14:0] rsp_demux_004_src0_channel;                                                         // rsp_demux_004:src0_channel -> crosser_006:in_channel
	...
	wire   [14:0] crosser_006_out_channel;                                                            // crosser_006:out_channel -> rsp_mux:sink4_channel
	...
	wire   [14:0] rsp_demux_004_src1_channel;                                                         // rsp_demux_004:src1_channel -> crosser_007:in_channel
	...
	wire   [14:0] crosser_007_out_channel;                                                            // crosser_007:out_channel -> rsp_mux_001:sink4_channel
	...
	wire          pwm_pio1_s1_agent_rdata_fifo_src_valid;                                             // pwm_pio1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_013:in_0_valid
	wire   [33:0] pwm_pio1_s1_agent_rdata_fifo_src_data;                                              // pwm_pio1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_013:in_0_data
	wire          pwm_pio1_s1_agent_rdata_fifo_src_ready;                                             // avalon_st_adapter_013:in_0_ready -> pwm_pio1_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_013_out_0_valid;                                                  // avalon_st_adapter_013:out_0_valid -> pwm_pio1_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_013_out_0_data;                                                   // avalon_st_adapter_013:out_0_data -> pwm_pio1_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_013_out_0_ready;                                                  // pwm_pio1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_013:out_0_ready
	wire    [0:0] avalon_st_adapter_013_out_0_error;                                                  // avalon_st_adapter_013:out_0_error -> pwm_pio1_s1_agent:rdata_fifo_sink_error
	wire          pwm_pio2_s1_agent_rdata_fifo_src_valid;                                             // pwm_pio2_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_014:in_0_valid
	wire   [33:0] pwm_pio2_s1_agent_rdata_fifo_src_data;                                              // pwm_pio2_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_014:in_0_data
	wire          pwm_pio2_s1_agent_rdata_fifo_src_ready;                                             // avalon_st_adapter_014:in_0_ready -> pwm_pio2_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_014_out_0_valid;                                                  // avalon_st_adapter_014:out_0_valid -> pwm_pio2_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_014_out_0_data;                                                   // avalon_st_adapter_014:out_0_data -> pwm_pio2_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_014_out_0_ready;                                                  // pwm_pio2_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_014:out_0_ready
	wire    [0:0] avalon_st_adapter_014_out_0_error;                                                  // avalon_st_adapter_014:out_0_error -> pwm_pio2_s1_agent:rdata_fifo_sink_error
